...
lib.ssMetadata = [
		{name:"openChest_demo3_atlas_1", frames: [[0,0,1083,1660]]},
		...
		{name:"openChest_demo3_atlas_4", frames: [[991,902,628,142],[0,0,1600,900],[0,902,989,768]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_6 = new lib.finalshot();
	this.instance_6.setTransform(9,24,0.5823,0.5823);
...
p.nominalBounds = new cjs.Rectangle(0,0,639.7,990.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/openChest_demo3_atlas_1.png?1618304505090", id:"openChest_demo3_atlas_1"},
		{src:"images/openChest_demo3_atlas_2.png?1618304505090", id:"openChest_demo3_atlas_2"},
		{src:"images/openChest_demo3_atlas_3.png?1618304505090", id:"openChest_demo3_atlas_3"},
		{src:"images/openChest_demo3_atlas_4.png?1618304505090", id:"openChest_demo3_atlas_4"}
	],
	preloads: []
};
